...
python train_remixmatch.py \
  ...
  --model-weight './saved_models/ReMixMatch_wrn_best_model_10_pct_cifar10.pt'
...
# python train_remixmatch.py \
#   --train-path-label '../data/cifer_100/ssl_cifar100_label_split_10_pct.pt' \
#   --train-path-unlabel '../data/cifer_100/ssl_cifar100_unlabel_split_10_pct.pt' \
...
#   --ema-decay 0.999 \
#   --save-dir './saved_models'\
#   --model-weight './saved_models/ReMixMatch_wrn_best_model_1_pct_cifar100.pt'