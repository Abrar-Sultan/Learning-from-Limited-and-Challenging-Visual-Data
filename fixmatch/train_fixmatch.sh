...
# in fixmatch_transform.py (inside "normalize_img" function) and 
# in fixmatch_dataset.py (inside "get_val_dataloader_labeled" function) 
...
python train_fixmatch.py \
  ...
  --seed 41\
  --num-class 10 \
  --model-weight './saved_models/fixmatch_wrn_best_model_10_pct_cifar10.pt'  
...
#   --num-class 100 \
#   --weight-decay 0.001 \
#   --model-weight './saved_models/fixmatch_wrn_best_model_20_pct_cifar100.pt'